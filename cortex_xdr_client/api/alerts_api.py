...
from cortex_xdr_client.api.models.alerts import (
    AlertSeverity,
    GetAlertsResponse, GetAlertsResponseV2, QuerySortType, QuerySortOrder,
)
...
class AlertsAPI(BaseAPI):
    ...
    # https://cortex-panw.stoplight.io/docs/cortex-xdr/a9873334620ed-get-alerts-multi-events-v2
